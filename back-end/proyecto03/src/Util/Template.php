    ...
    public function parse($template_file) {
        if (file_exists($template_file)) {
            ...
            while (true) {
                ...
                $partial = file_get_contents('src/View/' . $partial_file . '.html');
...
function view($filename, $variables = []) {
    ...
    if (file_exists('src/View/' . $filename . '.html'))
        return $template->parse('src/View/' . $filename . '.html');
    if (file_exists('src/View/' . $filename . '.php')) {
        extract($variables);
        ob_start();
        include('src/View/' . $filename . '.php');
        return ob_get_clean();
    }
